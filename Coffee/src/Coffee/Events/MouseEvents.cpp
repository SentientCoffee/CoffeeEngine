...
std::string MouseMovedEvent::toString() const {
	std::string buffer = "MouseMoved: " + std::to_string(_mouseX) + ", " + std::to_string(_mouseY);
	return buffer;
}

std::string MouseButtonPressedEvent::toString() const {
	std::string buffer = "MouseButtonPressed: " + std::to_string(_mouseButton);
	return buffer;
}

std::string MouseButtonReleasedEvent::toString() const {
	std::string buffer = "MouseButtonReleased: " + std::to_string(_mouseButton);
	return buffer;
}

std::string MouseScrolledEvent::toString() const {
	std::string buffer = "MouseScrolled: " + std::to_string(_xOffset) + ", " + std::to_string(_yOffset);
	return buffer;
}
